...
#
#input: plot_Epot_over_U_vary_k_epstex.sh d p potmod k1 k2 ...
if [ $# -eq 0 ]
then
    echo "$0:Error command arguments missing!"
    echo "Usage: plot_Epot_over_U_vary_k_epstex.sh d p trigger xMin xMax k1 k2 .."	
...
folder="/Users/jh/Documents/workspace-cpp/SingleParticleSimulation/sim_data/noreset/"

#outfile is file to save plot to
outfile="Epot_over_U_at_d$1_p$2_k"
if  [ $3 = "DH" ] || [ $3 = "ranPot" ] || [ $3 = "Bessel" ] || [ $3 = "potMod" ] || [ $3 = "2ndOrder" ]
	then
	potmod=/$3
    outfile="Epot_over_U_with_$3_p$2_d$1_k"
fi
...
do
    ...
    find $folder -name k$k -type d  | while read line1
    ...
    echo "\"tmp/plotdata_$i.txt\" u 1:2:3 ls 1 pt $j lc rgb ${color[$j-1]} ti \"\$k = $frac \\\\\\\\, b\$\", \\" >> tmp/plot.gp #lw 4 ps 2
    outfile+="_$k"
