...
then
    ...
    echo "Usage: plot_D_over_k_vary_p_const_U.sh d/e U trigger p1 p2 .."
    echo "For Potential modification: potmod = on"
    echo "NOTE: U needs to be an integer !"
	echo "NOTE 2: Trigger can be: LJ, steric, steric2"
    exit 1
fi
...
folder=/Users/jh/Documents/workspace-cpp/SingleParticleSimulation/sim_data/noreset/badmobM/lubCorr/$trigger/dt0.0005/t200/d$d/b10$e
