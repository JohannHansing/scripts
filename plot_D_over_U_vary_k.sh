...
#
#input: plot_D_over_U_vary_k.sh d/a p trigger xMin xMax k1 k2 ...
if [ $# -eq 0 ]
then
	echo ""
    echo "$0:Error command arguments missing!"
    echo "Usage: plot_D_over_U_vary_k.sh d/a p trigger xMin xMax k1 k2 .."	
    echo "NOTE: k needs to be written as k = x.xxx !"
	echo "NOTE 2: Trigger can be: potMod, DH, Bessel, ranPot, off, no or HI, in the latter case 'a' must be provided"
    exit 1
fi
...
if  [ $3 != "DH" ] && [ $3 != "ranPot" ] && [ $3 != "Bessel" ] && [ $3 != "potMod" ] && [ $3 != "2ndOrder" ] && [ $3 != "off" ] && [ $3 != "no" ] && [ $3 != "HI" ]
	then
...
if  [ $3 = "HI" ]
    then
    folder=/Users/jh/Documents/workspace-cpp/SPS/Release/sim_data/noreset/steric/dt0.001/t200/a$1/d0/b10/p$2
	outfile="D_over_U_with_$3_a$1_p$2_k"
	MSD="MSD"
fi
...
echo "set yrange [-0.02:1.3]" >> tmp/plot.gp
